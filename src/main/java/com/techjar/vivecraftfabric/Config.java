...
public class Config {
	...
	static {
		...
		blockList = builder.comment("List of blocks to whitelist or blacklist").defineList("blocklist", Arrays.asList("white_wool", "dirt", "grass_block"), (s) -> s instanceof String && Registry.BLOCK.containsKey(new ResourceLocation((String)s)));
		builder.pop(); // climbey
